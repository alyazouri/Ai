// ============================================================
// PUBG MOBILE — Jordan Master PAC v5.0 Enhanced
// ✦ Merged: All Jordan ISPs + Extended Ranges ✦
// ✦ Low Ping | Stable Connection | All Jordan Players ✦
// ✦ Umniah | Orange | Zain | Batelco | Link | VTEL ✦
// ============================================================

// ═══════════════════════════════════════════════════════════
// PROXIES — Optimized for Low Ping
// ═══════════════════════════════════════════════════════════
...
var LOBBY_POOL = [
  ...
  "PROXY 46.23.112.10:443",
  "PROXY 86.108.1.1:443",
  "PROXY 94.249.1.1:443"
];
...
var CACHE_TTL       = 300000;  // 5 min — DNS cache (reduced for freshness)
var SESSION_TIMEOUT = 90000;   // 90 sec — match session window (increased)
var REGION_LOCK_TTL = 7200000; // 2 hr  — region lock lifetime
var RATE_WINDOW     = 3000;    // 3 sec — rate-limit window
var RATE_LIMIT      = 300;     // max requests per window
var RETRY_DELAY     = 100;     // ms between retries
var MAX_RETRIES     = 3;
...
// ═══════════════════════════════════════════════════════════
// JORDAN IPv4 RANGES — ALL ISPs COMPREHENSIVE
// Umniah | Linkdotnet | Orange/JDC | Batelco | Zain
// VTEL | Al-Mouakhah | JT PSC | Data Centers
// ═══════════════════════════════════════════════════════════

var JORDAN_IPV4 = [
  // ── Umniah (Full Coverage) ──
  ...
  // ── Linkdotnet-Jordan (Full Coverage) ──
  ...
  ["82.212.112.0",  20], ["82.212.64.0",    18],
...
var JORDAN_IPV6_PREFIXES = [
  ...
  "2a06:8ec0",
  "2001:41f0"   // General JO
];

// Match server IPv6 ranges (Orange JO)
...
var KNOWN_JO_HOSTS = [
  ...
  "46.23.112",  "109.107.",   "149.200.",
  "188.248.",   "178.238.",   "46.32.",
  "77.245.",    "80.90.",     "94.142."
];
...
// ═══════════════════════════════════════════════════════════
// PROXY SELECTION — Multi-tier with failover
// ═══════════════════════════════════════════════════════════
...
function FindProxyForURL(url, host) {
  try {
    ...
    // ── 14. UNKNOWN with valid JO/ME IP ──
