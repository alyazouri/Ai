// ================================================================
//
//   🎮 PUBG Mobile - JORDAN ULTIMATE PAC
//   🇯🇴 تجنيد أردني بحت + أقوى سيرفرات للبنق الأقل
//
//   Version:  9.0 - FINAL ULTIMATE
//
...
//
//   المنطق:
//   كل طلب PUBG يمر بالبروكسي الأردني
//   = اللعبة تراك كلاعب أردني
//   = تطابقك مع لاعبين أردنيين
//   = تجنيد سريع + لاعبين كثير
//
// ================================================================
...
var MAT = "SOCKS5 " + PX + ":20001; SOCKS " + PX + ":20003; DIRECT";
var DIR = "DIRECT";


// ╔══════════════════════════════════════════════════════════╗
// ║   ② أقوى سيرفرات للبنق الأقل (مرتبة حسب القرب)       ║
// ╚══════════════════════════════════════════════════════════╝

// ════════════════════════════════════════════════
//  Tier 1 - أقوى وأسرع (بنق 5-20ms من الأردن)
// ════════════════════════════════════════════════
...
var SRV_TIER1 = [
    ...
    // ── 🇦🇪 Tencent Cloud UAE/Dubai ──
    //    البنق من الأردن: ~15-25ms
    //    سيرفرات PUBG الرسمية للشرق الأوسط
    "49.51.0.0/16",
    "49.51.64.0/18",
    "49.51.128.0/17",
    "43.154.0.0/15",
...
// ── دمج كل سيرفرات المباريات ──
var MS4 = [].concat(SRV_TIER1, SRV_TIER2, SRV_TIER3);


// ════════════════════════════════════════════════
//  سيرفرات المباريات IPv6
// ════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════
//  ⑥-ج  اللوبي والتجنيد ← بورت 9030
// ════════════════════════════════════════════════════

var D_LOB = [

    // ═══════════════════════════════════════════
    //  🔍🔴 التجنيد والبحث عن لاعبين (الأهم!)
    //  كل هالدومينات تمر بالبروكسي الأردني
    //  عشان PUBG يشوفك أردني = لاعبين أردنيين
    // ═══════════════════════════════════════════
...
function FindProxyForURL(url, host) {
    ...
    // ════════════════════════════════════════════
    //  ④ كل شي PUBG (لوبي + تجنيد + كل شي)
    //     → يمر بالبروكسي الأردني
    //     = اللعبة تراك أردني
    //     = لاعبين أردنيين كثار
    // ════════════════════════════════════════════
    if (dM(h, D_LOB)) {
