...
// ║   🇯🇴 أردنيين فقط - تجنيد فوري - بدون انتظار               ║
// ║                                                              ║
// ║   📌 البروكسي الأردني: 212.35.66.45 (Zain JO)              ║
// ║   🏠 اللوبي + تجنيد  → SOCKS5 212.35.66.45:1080           ║
// ║   🎮 المباريات       → SOCKS5 212.35.66.45:20005           ║
// ║   🎤 الصوت           → DIRECT                               ║
// ║   🛡️ الحماية          → DIRECT                               ║
// ║                                                              ║
// ╚══════════════════════════════════════════════════════════════╝
...
var LOB = "SOCKS5 " + PX + ":" + PRT_LOB + "; SOCKS " + PX + ":" + PRT_LOB + "; HTTP " + PX + ":" + PRT_LOB + "; DIRECT";
var MAT = "SOCKS5 " + PX + ":" + PRT_MAT + "; SOCKS " + PX + ":" + PRT_MAT + "; HTTP " + PX + ":" + PRT_MAT + "; DIRECT";
var DIR = "DIRECT";


// ╔══════════════════════════════════════════════════════════════╗
// ║          ② نطاقات أردنية شاملة IPv4                         ║
// ║  🎯 كل شبكات الأردن بدون استثناء                           ║
// ╚══════════════════════════════════════════════════════════════╝
...
var JO4 = [
    ...
    "212.34.64.0/18",
    "212.34.96.0/19",
    "212.35.0.0/16",              // بروكسيك 212.35.66.45
    "212.35.64.0/18",             // نطاق بروكسيك بالتحديد
    "212.35.66.0/24",             // نطاق بروكسيك بالتحديد
...
// ╔══════════════════════════════════════════════════════════════╗
// ║  ④ دومينات DIRECT (صوت + حماية + تقارير)                   ║
...
// ╔══════════════════════════════════════════════════════════════╗
// ║  ⑤ دومينات المباريات ← بورت 20005                          ║
// ║  🎮 سيرفرات اللعب الفعلية                                  ║
// ╚══════════════════════════════════════════════════════════════╝
...
// ╔══════════════════════════════════════════════════════════════╗
// ║  ⑥ كل شي PUBG ← بورت 1080 (لوبي + تجنيد + كل شيء)        ║
// ║  🔴🔴🔴 هاي أهم شي للتجنيد 🔴🔴🔴                          ║
// ╚══════════════════════════════════════════════════════════════╝
...
// ╔══════════════════════════════════════════════════════════════╗
// ║  ⑧ الدالة الرئيسية                                        ║
// ║  🎯 كل شي يمر بالبروكسي الأردني                           ║
// ║     ما عدا الصوت والحماية                                  ║
// ╚══════════════════════════════════════════════════════════════╝
...
function FindProxyForURL(url, host) {
    ...
    // ════════════════════════════════════════════════════════
    //  ① صوت + حماية → DIRECT (بدون تقطيع + بدون بان)
    // ════════════════════════════════════════════════════════
    if (dM(h, D_DIR)) return DIR;

    // ════════════════════════════════════════════════════════
    //  ② المباريات → بورت 20005
    // ════════════════════════════════════════════════════════
    if (isMS(host)) return MAT;
    if (dM(h, D_MAT)) return MAT;

    // ════════════════════════════════════════════════════════
    //  ③ كل شي PUBG → بورت 1080
    //     لوبي + تجنيد + كل شيء
